...
const FName ASpaceHarvestShooterPawn::MoveForwardBinding("MoveForward");
const FName ASpaceHarvestShooterPawn::MoveRightBinding("MoveRight");
const FName ASpaceHarvestShooterPawn::FireForwardBinding("FireForward");
const FName ASpaceHarvestShooterPawn::FireRightBinding("FireRight");
